...
- Supported interpreter range for full project setup MUST be:
    - `>=3.10`
    - `<3.12`
- `run.py setup` SHOULD prefer `3.11`, then `3.10`, before fallback.
...
- [ ] `python run.py setup` automatically selects a supported interpreter (`3.11`/`3.10`) for `.venv` creation when available. (manual acceptance)
